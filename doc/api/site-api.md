...
- [live/sites/v1alpha1/site.proto](#live/sites/v1alpha1/site.proto)
    ...
    - [TriggerCloneRefreshRequest](#ddev.sites.v1alpha1.TriggerCloneRefreshRequest)
    - [TriggerCloneRefreshResponse](#ddev.sites.v1alpha1.TriggerCloneRefreshResponse)
...
| TriggerCloneRefresh | [TriggerCloneRefreshRequest](#ddev.sites.v1alpha1.TriggerCloneRefreshRequest) | [TriggerCloneRefreshResponse](#ddev.sites.v1alpha1.TriggerCloneRefreshResponse) | TriggerCloneRefresh refreshes already existing clone |
...
| creationTime | [string](#string) |  | Creation Timestamp of site using RFC-3339 |
...
<a name="ddev.sites.v1alpha1.TriggerCloneRefreshRequest"></a>

### TriggerCloneRefreshRequest
...
| ----- | ---- | ----- | ----------- |
| operationRef | [string](#string) |  | `Required` Reference to the clone site operation |
| server | [bool](#bool) |  | `Optional` Whether the site should be cloned again |
| database | [bool](#bool) |  | `Optional` Whether the database should be cloned again |
| filestore | [bool](#bool) |  | `Optional` Whether the filestore should be cloned again |
...
<a name="ddev.sites.v1alpha1.TriggerCloneRefreshResponse"></a>

### TriggerCloneRefreshResponse
